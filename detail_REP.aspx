<%@ Page Language="C#" AutoEventWireup="true" CodeFile="detail_REP.aspx.cs" Inherits="_detail_REP" MasterPageFile="~/MasterPage.master" ViewStateEncryptionMode="Always"%>
  ...
  <tr>
    ...
    <table width="750px" border="0" cellspacing="0" cellpadding="0" class="css">
      ...
      <tr>
        <td width="6px"></td>
        <td colspan="2">
           <asp:Label ID="lblGroup" runat="server" Text="เฉพาะกลุ่ม :" CssClass="css" Visible="false"></asp:Label>
      ...
      <asp:HiddenField ID="tParam" Value="" runat="server" />
