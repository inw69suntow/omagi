...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mass_member_entry.aspx.cs" Inherits="_mass_member_entry" MasterPageFile="~/MasterPage.master" ViewStateEncryptionMode="Always"%>
...
<table width="750px" border="0" align="center" cellspacing="0" cellpadding="0" class="css">
  <tr>
    <td style="height:25px; width: 750px;" class="header_1">ข้อมูลสมาชิกมวลชน</td>
  </tr>
</table>
        ...
        <table width="750px" border="0" cellspacing="0" cellpadding="0" class="css">
            <tr>
                ...
                <th style="height:20px; width:648px;" align="left" background="photo/box_topbg.gif">
                    <div align="left  valign="left"><b>รายนามสมาชิกกลุ่มมวลชน</b> <asp:Label runat="server" ID="lblGroupName" Text=""/>
                    </div>
                </th>
			...
			<b>นำเข้าจาก Excel : </b>
                               <%-- <input type="file" id="exclFile" class="css"/>
                                <asp:Button ID="btnImport" runat="server" CssClass="css" Text="นำเข้า" 
                                 ...
                                 <asp:FileUpload ID="exclFile" runat="server" class="css"/>
                                 <asp:Button ID="btnImport" runat="server" CssClass="css" Text="นำเข้า" 
    ...
    <td align="center" valign="top">
            ...
            <tr>
                <td>
                    <table border="0" align="center" width="100%" cellspacing="0" cellpadding="0">            
                       <tr height="20px">
                            <td class="choice" style="width: 100px">หมายเลขสมาชิก:</td>
                            <td class="choice" >
                                <asp:TextBox ID="txtMemID" runat="server" width="200px" MaxLength="500" CssClass="css"/>
                            </td>
                        </tr>
                        <tr height="20px">
                        ...
                        <tr height="20px">
                            <td class="choice" >วันเริ่มสมาชิกภาพ:</td>
                            <td class="choice" >
                        ...
                        <tr height="20px">
                            <td class="choice">วันสิ้นสุดสมาชิกภาพ:</td>
                            <td class="choice">
                        ...
                        <tr height="20px">
                            ...
                            <td class="choice" >
                                ...
                                <font color="red">*</font>
                                 ...
                                 <asp:RegularExpressionValidator ID="egtxtCardID"  ControlToValidate="txtCardID" runat="server"
                        ...
                        <tr height="20px">
                            ...
                            <td class="choice">
                                <asp:Textbox ID="txtAddrNo" runat="server" CssClass="css" Width="200" MaxLength="250" />
                        ...
                        <tr height="20px">
                            ...
                            <td class="choice">
                                ...
                                <asp:RegularExpressionValidator ID="egtxtMoo"  ControlToValidate="txtMoo" runat="server"
                                    ErrorMessage="ต้องเป็นตัวเลขเท่านั้น"
                                    ValidationExpression="\d+">
                       ...
                       <tr height="20px">
                        ...
                        <tr height="200px">
                            <td >รูปถ่ายที่บันทึกไว้<br />(150x200 JPG 10K):</td>
                            <td >
